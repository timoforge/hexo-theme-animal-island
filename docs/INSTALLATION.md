...
本主题是标准 Hexo 主题，可以通过 Git 克隆、源码复制或软链接安装到任意 Hexo 项目的 `themes/` 目录中。

> 使用限制：本项目仅限个人学习、研究与非商业演示使用，严禁商业使用。安装和使用前请阅读 [LEGAL_NOTICE.md](../LEGAL_NOTICE.md)。
...
如果项目 `package.json` 已经定义了构建命令，也可以使用：
