...
<p align="center">
  <a href="./PROJECT_MANUAL.md">English</a> · <strong>简体中文</strong>
</p>

这份手册面向实际使用者，说明如何把 Animal Island 作为一个个人学习与非商业用途主题维护。

> ⚠️ **使用限制：** 本项目仅限个人学习、研究与非商业演示使用，严禁商业使用。使用前请阅读 [LEGAL_NOTICE.md](../LEGAL_NOTICE.md)。

## 1. 🏝️ 初次接入

1. 把主题复制或克隆到 Hexo 项目的 `themes/animal-island`。
